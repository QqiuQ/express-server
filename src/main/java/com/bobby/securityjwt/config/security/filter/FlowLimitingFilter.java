package com.bobby.securityjwt.config.security.filter;

import com.bobby.securityjwt.common.AjaxResult;
import com.bobby.securityjwt.common.Const;
import com.bobby.securityjwt.util.FlowUtils;
...
public class FlowLimitingFilter extends HttpFilter {
    ...
    private void writeBlockMessage(HttpServletResponse response) throws IOException {
        ...
        writer.write(AjaxResult.error(AjaxResult.HttpStatus.FORBIDDEN, "操作频繁，请稍后再试").asJsonString());
